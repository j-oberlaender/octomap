...
namespace octomap {
  ...
  void OcTreeDrawer::setOcTreeInternal(const OcTree<COPY_ON_WRITE>& octree, const pose6d& origin, int map_id_) {
    this->map_id = map_id_;
    ...
    for(typename OcTree<COPY_ON_WRITE>::const_tree_iterator it = octree.begin_tree(this->m_max_tree_depth),
